...
class ContactTestCase(APITestCase):
    ...
    def test_create_contact(self):
        ...
        self.assertEqual(Contact.objects.count(), 1)  # there is at least one entry in the database
        self.assertEqual(Contact.objects.get().title, "Billy Smith")  # title of this entry from the date
